...
这是一个适合放到简历中或发送给用人单位查看的静态个人网站。网站采用银白色编辑式设计，包含个人主页、经历、技术能力、证书档案和独立项目展示页。

项目页 `projects.html` 收录项目简介、个人职责、系统框架图和演示视频区域。演示视频文件的接入方法记录在 `assets/projects/README.md`。
